...
[`recall()`](https://mlr3measures.mlr-org.com/reference/tpr.md) R and
[`specificity()`](https://mlr3measures.mlr-org.com/reference/tnr.md) S
as \$\$ \sqrt{\mathrm{R} \cdot \mathrm{S}}. \$\$
