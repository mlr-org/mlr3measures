assert_binary = function(truth, response = NULL, prob = NULL, positive = NULL) {
...
assert_classif = function(truth, response = NULL, prob = NULL) {
...
assert_regr = function(truth, response) {
